...
namespace LanternaApp1
{
    public partial class MainPage : ContentPage
    {
        ...
        public MainPage()
        {
            ...
            btnOnOff.Source = ImageSource.FromResource("LanternaApp1.Imagens.of.png");
        ...
        private async void Carrega_Informacoes_Bateria()
        {
            try
            {
                ...
                {
                    lbl_bateria_fraca.Text = "Don't Have Nothing For U Here";
                }
            }
            catch (Exception ex)
            {
                await DisplayAlert("Houve um Erro Aqui :\n ", ex.Message, "OK");
            }
        }
        ...
        private async void btnOnOff_Clicked(object sender, EventArgs e)
        {
            try
            {
                if (!lanterna_ligada)
                {
                    ...
                    btnOnOff.Source = ImageSource.FromResource("LanternaApp1.Imagens.on.png");
